...
programa
{
	funcao inicio()
	{
		...
		escreva("O resultado do CÁLCULO MANUAL é: ", calculaQuadradoManual(num01, num02))
		
	     escreva("\nO resultado do primeiro cálculo é: ", calculaQuadradoAutomatico (5.0, 6.0))		
	     escreva("\nO resultado do segundo cálculo é: ", calculaQuadradoAutomatico (2.0, 4.0), "\n")
